...
# وب‌سرور فوق‌العاده سریع و سبک برای چراغ سبز رندر
...
async def message_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id == ADMIN_ID:
        if update.message.reply_to_message:
            try:
                # پیدا کردن آیدی مشتری از متن یا کپشن پیام ریپلای شده
                ...
                if target_text and "User ID:" in target_text:
                    ...
                    # کپی و ارسال دقیق پیام ادمین (متن، عکس، فایل یا کانفیگ) برای مشتری
...
if __name__ == "__main__":
    # روشن کردن فوری وب‌سرور برای فریب دادن رندر
